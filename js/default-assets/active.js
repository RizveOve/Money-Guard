(function ($) {
    ...
    var mg_window = $(window);

    // ****************************
    // :: 1.0 Preloader Active Code
    // ****************************

    mg_window.on('load', function () {
    ...
    // ****************************
    if ($.fn.imagesLoaded) {
        $('.mg-portfolio-area, .mg-blog-masonary').imagesLoaded(function () {
            ...
            // init Isotope
            var $grid = $('.mg-portfolio-area, .mg-blog-masonary').isotope({
                itemSelector: '.mg-portfolio-item, .mg-blog-masonary-item',
                percentPosition: true,
                masonry: {
                    columnWidth: '.mg-portfolio-item, .mg-blog-masonary-item'
                }
            });
        });
    }
